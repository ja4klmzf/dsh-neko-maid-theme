...
- 💬 **右侧本会话提问导航**（1:1 复刻 chat.deepseek.com scroll-nav）：右缘磨砂胶囊内每条提问为一条短线、当前提问蓝色加粗放大；悬停展开 240px 面板显示提问文字，点击跳转到对应消息，滚动时高亮跟随，**移开自动回收**，小窗自动隐藏
- ⬇ **回到最新按钮**：聊天上翻时对话框上方出现 ▼ 箭头，点击平滑滚回最新消息
